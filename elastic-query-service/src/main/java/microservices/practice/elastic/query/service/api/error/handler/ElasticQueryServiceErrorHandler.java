package microservices.practice.elastic.query.service.api.error.handler;
...
public class ElasticQueryServiceErrorHandler {
    ...
    @ExceptionHandler(AccessDeniedException.class) // @ExceptionHandler sets a specific exception to handle
