package microservices.practice.api.error.handler;
...
@ControllerAdvice // Used to create a global exception handler
public class ElasticQueryWebClientErrorHandler {
    ...
    public String handle(AccessDeniedException e, Model model) {
        ...
        model.addAttribute("error_description, You are not authorised to access this resource!");
        return "error";
    }
