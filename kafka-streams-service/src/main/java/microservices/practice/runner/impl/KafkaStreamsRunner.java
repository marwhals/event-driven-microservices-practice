...
import microservices.practice.demo.config.KafkaStreamsConfigData;
...
public class KafkaStreamsRunner implements StreamsRunner<String, Long> {
    ...
    private volatile ReadOnlyKeyValueStore<String, Long> keyValueStore; //Volatile keyword means threads see the latest value from main memory instead of from CPU caches
