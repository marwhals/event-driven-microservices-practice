package microservices.practice.elastic.query.util;
...
public class ElasticQueryUtil<T extends IndexModel> {
    ...
    public Query getSearchQueryById(String id) {
        return new NativeSearchQueryBuilder() // Provides methods like withIds, withQuery to create a spring elasticsearch Query object
